...
try:
    ...
    data_path = (
        ...
        / "testdata/muphys_graupel_data/mini/input.nc"
    )
    if data_path.exists():
...
try:
    ...
    @jax.jit
    def test_all_precip(
        zeta, rho, qr, qs, qi, qg, vc_r, vc_s, vc_i, vc_g, kmin_r, kmin_s, kmin_i, kmin_g
    ):
...
try:
    from muphys_jax.core import properties as props, thermo
    from muphys_jax.core.common import constants as const
    from muphys_jax.core.definitions import TempState
    ...
    print("  Step 1 (q_t_update): PASSED")
    ...
    print("  Step 2 (precipitation): PASSED")
    ...
    t_out.block_until_ready()
    print("  Step 3 (temp correction): PASSED")
