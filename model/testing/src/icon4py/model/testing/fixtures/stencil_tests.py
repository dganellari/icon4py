...
def _get_grid_manager_from_preset(
    ...
    *,
    ...
    # An explicit `--grid <name>:<levels>` wins. Without one, the benchmark presets keep
    # their own deeper default -- production runs 120 levels, the correctness grids do not.
    if num_levels is None:
        num_levels = (
            BENCHMARK_DEFAULT_LEVELS
            if grid_preset.startswith("icon_benchmark")
